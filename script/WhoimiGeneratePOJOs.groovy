...
typeMapping = [
        ...
        (~/(?i)blob|longblob|mediumblob/)   : "byte[]",
        (~/(?i)binary|bfile|clob|raw|image/): "java.io.InputStream",
        (~/(?i)/)                           : "String"
]
...
def generate(out, className, fields, table) {
    def catalog = DasUtil.getCatalog(table)
    ...
    out.println "@Entity"
    out.println "@Table (name =\"" + table.getName() + "\",catalog = \"" +schema +"\" )"

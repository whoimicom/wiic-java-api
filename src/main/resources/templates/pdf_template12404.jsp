...
<div style="padding:15px 0;border-bottom:1px solid #f00;overflow: hidden;position: relative;text-align: right;">
    ...
    <font style="bottom:30px;right:10px;color:black;font-size:1.5em;font-weight:bold;">客服热线 <c:choose>
...
<h3 style="line-height: 20px">尊敬的<u>&nbsp;${member.realName}&nbsp; </u><c:if test="${member.gender eq '0'}">先生</c:if>
    ...
    &nbsp;&nbsp;非常感谢您选择${fundsSource.companyName}（简称“红犇”）的分期服务。希望我们的服务在提高您生活品质的同时，让您的生活更加便利、现代。<br/>
    &nbsp;&nbsp;以下是您服务费支付详情：<br/>
    ...
    <c:otherwise>
        ...
        <div style="padding-left: 10px;">
            ...
            <div style="padding-left: 33px;font-size: 1em;margin-top: 10px;">
                扫描上方的二维码下载惠花APP在线自助操作，掌握第一手贷款及合同相关信息若您还有其他疑问和建议，欢迎致电红犇全国客服热线：4000-353-999
            </div>
        </div>
    </c:otherwise>
</c:choose>

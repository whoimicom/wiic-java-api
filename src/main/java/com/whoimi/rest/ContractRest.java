...
import com.whoimi.utils.PdfUtils;
...
public class ContractRest {
    ...
    /**
     * 查看模板
     * localhost:1987/wiic-java-api/contract/preview/ApplicationForm
     *
     * @param tempName 模板名称
     * @param model    model
     * @return 模板
    ...
    public String preview(@PathVariable String tempName, Model model) {
        ...
        Capital capital = new Capital("XX融资担保有限公司", "担保公司", "http://localhost:1987/wiic-java-api/loan.png",
    ...
    /**
     * 生成根据模板生成PDF
     * localhost:1987/wiic-java-api/contract/generate/ApplicationForm
     *
     * @param tempName 模板名称
     * @return 路径
     */
    ...
    public String generate(@PathVariable String tempName) throws IOException {
        String uri = "http://localhost:1987/wiic-java-api/contract/preview/" + tempName;
    ...
    /**
     * localhost:1987/wiic-java-api/contract/generateAll
     */
